...
const LoginPage = () => {
    ...
    return (
        <div className="d-flex align-items-center justify-content-center min-vh-100" style={{ backgroundColor: '#9E9E9E' }}>
                        ...
                        {view === 'login' ? (
                            <form onSubmit={handleLogin} className="d-flex flex-column h-100">
                                ...
                                <div className="text-end mb-4">
                                    <Link to="/forgot-password" className="text-muted p-0 text-decoration-none" style={{ fontSize: '10px' }}>Forgot Password?</Link>
                                </div>
